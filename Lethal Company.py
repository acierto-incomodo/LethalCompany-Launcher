...
URL_ARCHIVO = "https://github.com/acierto-incomodo/LethalCompany-Launcher/releases/latest/download/LethalCompany_Launcher_Installer.exe"
NOMBRE_ARCHIVO = "LethalCompany_Launcher_Installer.exe"
